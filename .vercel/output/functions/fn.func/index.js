          ...
          if (isArray_1.default(obj)) {
            for (var index4 = 0; index4 < obj.length; index4++) {
              ...
              if (/\[\]$/.test(prefix)) {
                ...
                buildParams(prefix + "[" + (typeof value === "object" && value !== null ? index4 : "") + "]", value, addFn);
              }
            }
            ...
            for (var _i = 0, _a = keys_1.default(obj); _i < _a.length; _i++) {
              var key2 = _a[_i];
              var value = obj[key2];
              buildParams(prefix + "[" + key2 + "]", value, addFn);
            }
          } else {
            addFn(prefix, obj);
          }
...
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    ...
    css$1 = {
      code: "#topModal.svelte-18s3qyj{visibility:hidden;z-index:9999;position:fixed;top:0;left:0;right:0;bottom:0;background:#4448;display:flex;align-items:center;justify-content:center}#modal.svelte-18s3qyj{position:relative;border-radius:6px;background:white;border:2px solid #000;filter:drop-shadow(5px 5px 5px #555);padding:1em}.visible.svelte-18s3qyj{visibility:visible !important}#modal-content.svelte-18s3qyj{max-width:calc(100vw - 20px);max-height:calc(100vh - 20px);overflow:auto}",
      map: null
    };
    ...
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      let count = 0;
      $$result.css.add(css);
      return `<div id="${"name"}" class="${"svelte-3fhak3"}"><span>Andrew</span>
    <div id="${"line"}" class="${"svelte-3fhak3"}"></div>
    <span>Crawley</span></div>
<div style="${"display:flex;flex-direction:column;justify-content:center;height:100vh;"}"><div id="${"center"}" class="${"svelte-3fhak3"}"><div id="${"image"}" class="${"svelte-3fhak3"}"><div class="${"box box-small svelte-3fhak3"}"></div>
            <div class="${"box box-tiny svelte-3fhak3"}"></div>
            <div class="${"box box-large svelte-3fhak3"}"></div></div>
        <div id="${"blurb"}" class="${"svelte-3fhak3"}"><div class="${"svelte-3fhak3"}"><p class="${"svelte-3fhak3"}">From Websites to Software</p>
                <p class="${"svelte-3fhak3"}">&amp;</p>
                <p class="${"svelte-3fhak3"}">Everything In-Between</p></div>
            <div id="${"enquire"}" class="${"svelte-3fhak3"}"><button class="${"svelte-3fhak3"}">ENQUIRE</button></div></div></div></div>


${validate_component(Modal, "Modal").$$render($$result, { id: "form" }, {}, {
        default: () => {
          return `<div style="${"min-width: 300px; width: 100%"}"><h1>Enquire</h1>

        <div style="${"width:100%"}"><h3 style="${"margin-bottom:10px"}">Email</h3>
            <input id="${"email"}" class="${"inp svelte-3fhak3"}" type="${"email"}"${add_attribute("value", email, 0)}></div>
        <div><h3 style="${"margin-bottom:10px"}">Body</h3>
            <textarea id="${"body"}" class="${"inp svelte-3fhak3"}" style="${"resize:none; height:200px"}" maxlength="${"255"}">${""}</textarea>
            <caption style="${"display:block;text-align:end;"}">${escape(count)}/255</caption></div>
        <div id="${"send"}" style="${"margin-bottom:10px;"}" class="${"svelte-3fhak3"}"><button class="${"svelte-3fhak3"}">SEND</button></div></div>`;
        }
      })}

${validate_component(Modal, "Modal").$$render($$result, { id: "response" }, {}, {
        default: () => {
          return `<p>Thank you for your enquiry</p>
...
var options = {
  ...
  templates: {
	...
	<style>
		...
		:root {
			--yellow: rgb(255, 193, 89);
			--yellow-darker: rgba(219, 165, 77, 1);
			--red: #7b0828;
			--black: #00272b;
		}
		...
		html {
			...
			background: linear-gradient(135deg, var(--yellow) 0%, var(--yellow-darker) 100%);
